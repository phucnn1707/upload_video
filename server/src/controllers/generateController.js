    ...
    await new Promise((resolve, reject) => {
      ffmpeg(updatedVideoPath)
        .videoFilter([
          ...
          `drawtext=text='${title}':fontfile=${fontPath}:fontcolor=white:fontsize=48:borderw=2:bordercolor=white:box=1:boxcolor=black@0.5:boxborderw=10:x=(w-text_w)/2:y=50`,
        ])
        .output(outputPath)
        .on('end', () => {
